...
const SEARCH_API = 'https://api.themoviedb.org/3/search/multi?api_key=3fd2be6f0c70a2a598f084ddfb75487c&query="'
function main() {
...
const search = document.getElementById('search');
  ...
  function getResults(page) {
    return axios.get(`https://api.themoviedb.org/3/trending/all/day?api_key=${apiKey}&page=${page}`);
  }
