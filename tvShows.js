...
function main() {
  ...
  function getResults(page) {
    return axios.get(`https://api.themoviedb.org/3/discover/tv?sort_by=popularity.desc&api_key=${apiKey}&page=${page}`);
  }
...
<div class="movie">
  <img src="${backdropPath(movie.backdrop_path)}" alt="${movie.name} backdrop">
